#!/bin/sh
# Installs or updates the "OpenCode Usage" widget in the current user's Plasma.
set -e

DIR=$(cd "$(dirname "$0")" && pwd)
ID="com.github.jefonseca.opencodeusage"
...
echo "Done. Add it from \"Add Widgets\" -> \"OpenCode Usage\"."
